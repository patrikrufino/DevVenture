...
public abstract class LearnItemDatabase extends androidx.room.RoomDatabase {
    ...
    private static volatile com.example.whatdoilearn.data.database.LearnItemDatabase INSTANCE;
    ...
    static final class LearnedItemDatabaseCallback extends androidx.room.RoomDatabase.Callback {
        ...
        private final void populateDatabase(com.example.whatdoilearn.data.database.LearnedItemDao learnedItemDao) {
        }
